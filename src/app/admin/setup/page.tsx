...
export default async function AdminSetup({
  ...
  return (
    <div style={{ display: "grid", gap: "16px" }}>
      <h1 style={{ fontSize: "28px" }}>Create First Admin</h1>
      {error && (
        <p style={{ color: "#ff9c9c" }}>
          {error === "missing" ? "Please fill all fields." : "Setup failed."}
        </p>
      )}
      <form action="/api/admin/setup" method="post" style={{ display: "grid", gap: "12px" }}>
